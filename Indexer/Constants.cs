...
{
    /// <summary>
    /// Class That holds all the indexer constant values 
    /// </summary>
    class Constants
    {
        
        #region stop_words
        public readonly static string[] StopWords = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against",
        ...
        #region initialize soundex dictionary list

        public readonly static Dictionary<char[], int> DictionarysoundexList = new Dictionary<char[], int>
        {
            {new char[] { 'a', 'e', 'i', 'o', 'u', 'h', 'w', 'y' }, 0},
            {new char[] { 'b', 'f', 'p', 'v' }, 1},
            {new char[] { 'c', 'g', 'j', 'k', 'q', 's', 'x', 'z' }, 2},
            {new char[] { 'd', 't' }, 3},
            {new char[] { 'l' }, 4},
            {new char[] { 'm', 'n' }, 5},
            {new char[] { 'r' }, 6},
